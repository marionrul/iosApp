...
class RdvNotificationCenter {
    
    /// Programmer une notification dans x secondes
    static func rdvNotification (nameRdv: String, docteurRdv: String, inSeconds: TimeInterval){
        ...
        content.title = nameRdv
        content.body = docteurRdv
    ...
    static func programmedAllNotificationRdv(nameRdv: String, docteurRdv: String, forDate: Date) {
        ...
        self.rdvNotification(nameRdv: nameRdv, docteurRdv: docteurRdv, inSeconds: inSeconds)
